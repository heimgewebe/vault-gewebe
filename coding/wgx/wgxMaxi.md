...
# --- Parser globaler Flags (bis Subcommand) ------------------------------------------------------
...
guard_run(){
  ...
  # Konfliktmarker in geänderten Dateien
  local with_markers=""
...
detect_web_dir(){ for d in apps/web web; do [[ -f "$d/package.json" ]] && { echo "$d"; return; } done; echo ""; }
