...
Minimalstruktur, klare Ontologie, mobile-first.

⸻

Unsicherheitsgrad: 0.12
Ursache: reale Nutzung noch nicht getestet.

Interpolationsgrad: 0.15
Annahme: Karte bleibt primärer Einstiegspunkt.

⸻

Humorrest

Ein gutes Interface ist wie ein gutes Netz:
Man sieht nur wenige Fäden – aber wenn man daran zieht, merkt man plötzlich, dass das ganze System daran hängt.