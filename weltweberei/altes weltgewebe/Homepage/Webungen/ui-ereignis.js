// ui-ereignis.js — Version: Σ.v∞.2.final

import { Validators } from './validation.js';
import { attachValidation, createGarnrolleSelect } from './form-components.js';
import { parseOptionalFloat } from './utility-core.js';
    ...
    showEreignisFormBtn.addEventListener('click', () => {
        ...
        form.addEventListener('submit', async e => {
            ...
            try {
                ...
                const lat = parseOptionalFloat(document.getElementById('ereignis-lat').value);
                const lng = parseOptionalFloat(document.getElementById('ereignis-lng').value);
